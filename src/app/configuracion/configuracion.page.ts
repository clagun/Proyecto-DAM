...
export class ConfiguracionPage implements OnInit {
  ...
  ngOnInit() {
    ...
    // consultamos el electrodoméstico guardado para compararlo con el select y escoger el guardado    
    this.itemSelecConfig=(JSON.parse(localStorage.getItem('data')))? JSON.parse(localStorage.getItem('data')):null;
  }
  ...
  compareWith(o1: Electromestico, o2: Electromestico) {
